...
public class OAuth20GetAccessToken {
  ...
  public static void main(String[] args) {
    TwitterCredentialsOAuth2 credentials = new TwitterCredentialsOAuth2("SsCCks7HWGtUK46Z4fjkDendw",
        "S4dX7K5ynXZRLJYIyilBgFSvNt7dJS4xij1rd0eMiPBLlTMixt",
        "JUQ1XtRqaybimM5IP6EYy00g1bC07i",
        "nwMxkTwwk4qmAqNq0IgrFxSVg94o3buozfvgrY2gXjWuJ");
  ...
  public static void callApi(TwitterCredentialsOAuth2 credentials) {
    ...
    try {
      // create tweet
      TweetCreateResponse result = apiInstance.tweets().createTweet(new CreateTweetRequest().text("Are you excited for the weekend?"));
